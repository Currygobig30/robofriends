...
const ScrollBox = (props) => {
    return (
        <div>
            <div style={{ overflowY: 'Scroll', border: '3px solid black', height: '450px', width: '1000px', margin: '30px auto'}}>
                {props.children}
            </div>
            <div style={{ overflowY: 'Scroll', border: '3px solid black', height: '200px', width: '500px', margin: '30px auto'}}>
